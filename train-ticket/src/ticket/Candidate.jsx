...
const Channel = memo(function Channle(props) {
  ...
  const src = useMemo(() => {
    return new URI("order.html")
      ...
      .toString();
  }, [trainNumber, departStation, arriveStation, type, departDate]);
...
Seat.propsTypes = {
  ...
  expandedIndex: PropTypes.func.isRequired,
